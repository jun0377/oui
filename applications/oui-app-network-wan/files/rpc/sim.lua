...
local Sim = {
    [1] = {
        settings = {
            ...
            alias = '5G-1',                         -- tag
            ttyusb = '',                            -- 拨号节点
            uciSection = 'sim1',                -- UCI配置文件section命名规范
            band = '',                              -- 设置的频段
    ...
    [2] = {
        settings = {
            ...
            alias = '5G-2',                         -- tag
            ttyusb = '',                            -- 拨号节点
            uciSection = 'sim2',                -- UCI配置文件section命名规范
            band = '',                              -- 设置的频段
            net = '',                               -- 入网方式设置：AUTO/SA/NSA/LTE
            apn = '',                               -- apn
            auth = '',                              -- 鉴权
    ...
    [3] = {
        settings = {
            ...
            alias = '5G-3',                         -- tag
            ttyusb = '',                            -- 拨号节点
            uciSection = 'sim3',                -- UCI配置文件section命名规范
            band = '',                              -- 设置的频段
            net = '',                               -- 入网方式设置：AUTO/SA/NSA/LTE
            apn = '',                               -- apn
            auth = '',                              -- 鉴权
    ...
    [4] = {
        settings = {
            ...
            alias = '5G-4',                         -- tag
            ttyusb = '',                            -- 拨号节点
            uciSection = 'sim4',                -- UCI配置文件section命名规范
            band = '',                              -- 设置的频段
            net = '',                               -- 入网方式设置：AUTO/SA/NSA/LTE
            apn = '',                               -- apn
            auth = '',                              -- 鉴权
    ...
    [5] = {
        settings = {
            ...
            alias = '5G-5',                         -- tag
            ttyusb = '',                            -- 拨号节点
            uciSection = 'sim5',                -- UCI配置文件section命名规范
            band = '',                              -- 设置的频段
            net = '',                               -- 入网方式设置：AUTO/SA/NSA/LTE
            apn = '',                               -- apn
            auth = '',                              -- 鉴权
